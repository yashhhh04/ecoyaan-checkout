        ...
        {["Cart", "Address", "Payment", "Done"].map((s, i) => (
          <div key={s} style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{
              ...
              background: "#2d5a27", color: "white", border: "2px solid #2d5a27",
            }}>
              ✓
            </div>
            <span style={{ fontSize: 12, color: i === 3 ? "#2d5a27" : "#999", fontWeight: i === 3 ? 600 : 400 }}>{s}</span>
            {i < 3 && <div style={{ width: 32, height: 2, background: "#2d5a27" }} />}
          </div>
        ))}
      </div>
